...
export interface OnboardingRepository {
  ...
  /**
   * GitHub contributors — distinct from DevTunnel contributors (section
   * 27). Capped to the first 25 for display; use `contributorCount` for
   * the repository's real total, not `contributors.length`.
   */
