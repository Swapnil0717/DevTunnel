...
import { HomeIcon, FolderIcon, ChecklistIcon, ToolIcon, UserIcon } from "./nav-icons";
...
export function AppBottomNav() {
  ...
  const links: readonly BottomNavItem[] =
    !user && status === "unauthenticated" ? GUEST_NAV_LINKS : NAV_LINKS;
