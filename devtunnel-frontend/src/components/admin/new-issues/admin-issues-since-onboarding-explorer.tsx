    ...
    <div>
      <div className="mb-3 flex flex-col gap-3">
        <div className="relative w-full sm:max-w-xs">
          <label htmlFor="admin-issues-since-onboarding-search" className="sr-only">
          ...
          <input
            id="admin-issues-since-onboarding-search"
            name="admin-issues-since-onboarding-search"
            type="search"
            value={query}
...
function FilterSelect({
  ...
  return (
    <div className="flex items-center gap-1.5">
      <label htmlFor={id} className="whitespace-nowrap text-[11.5px] font-medium text-text-faint">
        {label}
      </label>
