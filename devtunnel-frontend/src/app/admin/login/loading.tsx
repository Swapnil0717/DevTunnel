...
/** `/admin/login` — calls `getServerUser()` to redirect an already-signed-in admin straight through. Matches the real page's wide wordmark logo + bordered `LoginCard` (title, subtitle, GitHub button, divider, terms). */
export default function AdminLoginLoading() {
  return (
    <BlueprintSheet
      sheetLabel="Sheet A9 — Admin sign-in"
