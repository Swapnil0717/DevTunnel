 ...
 * yet, never `undefined` (rule 49). Publicly viewable but `noindex,follow`: it mirrors a third-party
 * GitHub repository that DevTunnel hasn't onboarded, and there are
 * thousands of these — indexing them all would create the thin,
 * duplicate pages rule 24 warns against. Links stay followable so the
 * onboarded pages they point at are still discovered.
 */
 ...
 * (`app/(public)/github-projects/[slug]/page.tsx`): fetches
