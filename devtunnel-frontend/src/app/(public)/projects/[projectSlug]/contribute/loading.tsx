 ...
 * buttons, a three-tab strip, a filter row, a list of task rows, and the
 * rail's stack of cards — so the swap to real content doesn't visibly
 * reflow. Same shimmer-skeleton convention as the project page's own
 * `loading.tsx`.
 */
