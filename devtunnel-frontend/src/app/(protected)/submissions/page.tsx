...
export const metadata: Metadata = buildMetadata({
  ...
  path: "/submissions",
  // Private, authenticated-only application UI (rule 18) — this route
  // lives under the `(protected)` group, whose layout requires a
  // backend-confirmed session for every page inside it.
  noIndex: true,
});
