...
This Code of Conduct applies within all project spaces (issues, pull requests, discussions, and any other DevTunnel communication channels), and also applies when an individual is officially representing the project in public spaces.
...
3. **Temporary Ban** — Temporary ban from interaction or contribution.
4. **Permanent Ban** — Permanent ban from any public interaction with the project.
